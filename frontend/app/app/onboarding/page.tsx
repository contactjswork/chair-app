      ...
      <div className={`flex-1 flex flex-col min-h-0 transition-all duration-180 ease-out ${animClass}`}>
        ...
        {step === 'genre' && (
          <div className="flex-1 flex flex-col px-5 pb-6 min-h-0">
            ...
            {/* Cartes principales — flex-1 pour remplir. (Essai « vraies
                photos plein cadre » du 16/09 retiré le jour même : cadrages
                imprévisibles, visages coupés — retour Julien « pas ouf ».
                Les illustrations restent la bonne réponse ICI ; les vraies
                photos vivent sur l'écran des styles juste après.) */}
