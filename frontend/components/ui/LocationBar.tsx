    ...
    <>
      <div className="px-4 md:px-8 max-w-6xl md:mx-auto pt-4">
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full border border-neutral-200 text-[12px] font-semibold text-neutral-700 hover:border-neutral-300 active:scale-[0.97] transition-all"
        >
