...
// Messages de validation Laravel par défaut, traduits en français — l'app
// était configurée en locale 'en' alors que 100% du produit est en français ;
// chaque erreur 422 renvoyée par l'API (inscription, profil, services,
// salon, offres d'emploi...) s'affichait donc en anglais côté frontend.
...
return [
    ...
    // Noms de champs lisibles — remplace "email" par "adresse email" etc.
    // dans les messages ci-dessus quand ils apparaissent à la place de
    // :attribute. Complète au fil des vrais champs utilisés par l'API.
    'attributes' => [
        'name' => 'nom',
        'email' => 'adresse email',
